...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(CS1_MPU_GPIO_Port, CS1_MPU_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : VM_EN_Pin FAN_EN_Pin */
  GPIO_InitStruct.Pin = VM_EN_Pin|FAN_EN_Pin;
  ...
  /*Configure GPIO pin : CS1_MPU_Pin */
  GPIO_InitStruct.Pin = CS1_MPU_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
